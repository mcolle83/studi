...
public class UtilisateurTest {
	...
	@Test
  	public void testGetUtilisateurByEmailAndMotdepasse() throws Exception {
	Mockito.when(utilisateurRepository.findByEmailAndMotdepasse("leonmarchand@gmail.com", "QuatreOr2024")).thenReturn(utilisateur);
   	Utilisateur result = utilisateurService.getUtilisateurByEmailAndMotdepasse("leonmarchand@gmail.com", "QuatreOr2024");
   	assertNotNull(result);
   	assertEquals("Marchand", result.getNom());
	assertEquals("Leon", result.getPrenom());
  	assertEquals("leonmarchand@gmail.com", result.getEmail());
	...
	Mockito.when(utilisateurRepository.findByEmailAndMotdepasse("leonmarchand@gmail.com", "QuatreOr2024")).thenReturn(utilisateur);
	Utilisateur result = utilisateurService.loginUtilisateur(utilisateur);
	assertEquals("Marchand", result.getNom());
	assertEquals("Leon", result.getPrenom());
  	assertEquals("leonmarchand@gmail.com", result.getEmail());
	assertEquals("QuatreOr2024", result.getMotdepasse());
  	}
	...
	assertEquals("DeuxBronzes2024", result.getMotdepasse());
  	}
